import { d as defineComponent, u as useRouter, a as useNuxtApp, o as onMounted, b as onNuxtReady, r as requestIdleCallback, c as onBeforeUnmount, e as cancelIdleCallback, h, f as resolveComponent, p as parseQuery, g as encodeRoutePath, s as shallowRef, i as ref, j as resolveRouteObject, k as preloadRouteComponents, l as unref, n as navigateTo, m as computed, q as joinURL, t as hasProtocol, v as isScriptProtocol, w as useRuntimeConfig, x as withTrailingSlash, y as withoutTrailingSlash, z as nuxtLinkDefaults, A as useHead, B as openBlock, C as createElementBlock, D as createBaseVNode, E as toDisplayString, F as createVNode, G as withCtx, H as createTextVNode } from "./ZIQbdsly.js";
        ...
        return h("a", {
          ...
          onClick: async (event) => {
            ...
            try {
              ...
              if (isHashLinkWithoutHashMode(to.value)) {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[0] || (_cache[0] = createBaseVNode("div", { class: "fixed left-0 right-0 spotlight z-10" }, null, -1)),
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("h1", {
            class: "font-medium mb-8 sm:text-10xl text-8xl",
            textContent: toDisplayString(__props.status)
          }, null, 8, _hoisted_3),
          createBaseVNode("p", {
